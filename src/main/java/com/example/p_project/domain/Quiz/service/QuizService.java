...
//    List<QuizResponseDTO> getRandomQuizzes(String category, Quiz.Difficulty difficulty, int count);
    ...
    /**
     * 특정 난이도의 모든 퀴즈를 랜덤하게 조회합니다.
     */
    List<QuizResponseDTO> getAllQuizzesByDifficulty(Quiz.Difficulty difficulty);

    /**
     * 특정 카테고리의 모든 퀴즈를 랜덤하게 조회합니다.
     */
    List<QuizResponseDTO> getAllQuizzesByCategory(String category);
}
